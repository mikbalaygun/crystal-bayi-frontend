        ...
        <div className="mt-8 pt-6 border-t border-kristal-500">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="text-sm text-kristal-100 text-center md:text-left">
              <p>© 2026 Kristal Aksesuar. Tüm hakları saklıdır.</p>
            </div>
            ...
            <div className="flex items-center space-x-2 text-kristal-200">
              ...
              <a
                href="https://selectiveyazilim.com"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-md transition-opacity hover:opacity-100"
              >
                <img 
