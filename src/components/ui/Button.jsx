...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-kristal font-medium transition-all duration-300 active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:active:scale-100 kristal-shine",
  {
    variants: {
      variant: {
